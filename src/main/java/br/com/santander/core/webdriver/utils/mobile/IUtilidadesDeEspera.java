...
public interface IUtilidadesDeEspera extends IUtilidadesDeElemento
{
	/**<p>Thread.sleep(milliseconds)</p>
	 * 
	 * Põe a Thread presente em estado de espera.*/
	default void espera( final int milliseconds )
	{
		try {
	...
	/**Retorna se isDisplayed().*/
	default boolean estaVisivel( WebElement element )
	{
		return estaVisivel( element, Tempo._60.vezesMil() );
	}
	
	/**Retorna se isDisplayed(), em um intervalo de tempo.*/
	default boolean estaVisivel( WebElement element, int miliSeg )
	{
		miliSeg = miliSeg / 1000;
		for ( int i = 1; i <= miliSeg; i++ )
		{
	...
	default boolean esperaAteEstarTicado(By by)
	{
		return esperaAteEstarTicado( by, Tempo._60.qtde() );
	}
	
	/**Espera até que um elemento esteja ticado/marcado ou retorna nulo.*/
	default boolean esperaAteEstarTicado(By by, int segundosAteTimeout)
	{
	...
	/**Espera até que um elemento esteja ticado/marcado ou retorna nulo.*/
	default boolean esperaAteEstarTicado(WebElement element)
	{
		return esperaAteEstarTicado( element, Tempo._60.qtde() );
	}
	
	/**Espera até que um elemento esteja ticado/marcado ou retorna nulo.*/
	default boolean esperaAteEstarTicado(WebElement element, int segundosAteTimeout)
	{
		return getWait().withTimeout( Duration.ofSeconds( segundosAteTimeout ) )
			.pollingEvery( Duration.ofMillis( Tempo._300.qtde() ) )
			.ignoring(NoSuchElementException.class)
	...
	default WebElement esperaAteEstarClicavel(By by) {
		return esperaAteEstarClicavel( by, Tempo._60.qtde() );
	}
	
	/**Espera até que um elemento esteja clicável ou retorna nulo.*/
	default WebElement esperaAteEstarClicavel(By by, int segundosAteTimeout)
	{
		return getWait().withTimeout( Duration.ofSeconds( segundosAteTimeout ) )
			.pollingEvery( Duration.ofMillis( Tempo._300.qtde() ) )
			.ignoring(NoSuchElementException.class)
	...
	/**Espera até que um elemento esteja clicável ou retorna nulo.*/
	default WebElement esperaAteEstarClicavel(WebElement element)
	{
		return esperaAteEstarClicavel( element, Tempo._60.qtde() );
	}
	
	/**Espera até que um elemento esteja clicável ou retorna nulo.*/
	default WebElement esperaAteEstarClicavel(WebElement element, int segundosAteTimeout)
	{
		return getWait().withTimeout( Duration.ofSeconds( segundosAteTimeout ) )
			.pollingEvery( Duration.ofMillis( Tempo._300.qtde() ) )
			.ignoring(StaleElementReferenceException.class)
	...
	default WebElement esperaVisibilidadeDe(By by)
	{
		return esperaVisibilidadeDe( by, Tempo._60.qtde() );
	}
	
	/**Espera até que um elemento esteja visível ou retorna nulo.*/
	default WebElement esperaVisibilidadeDe(By by, int segundosAteTimeout)
	{
		return getWait().withTimeout( Duration.ofSeconds( segundosAteTimeout ) )
			.pollingEvery( Duration.ofMillis( Tempo._300.qtde() ) )
			.ignoring(StaleElementReferenceException.class)
	...
	/**Espera até que um elemento esteja visível ou retorna nulo.*/
	default WebElement esperaVisibilidadeDe(WebElement element)
	{
		return esperaVisibilidadeDe( element, Tempo._60.qtde() );
	}
	
	/**Espera até que um elemento esteja visível ou retorna nulo.*/
	default WebElement esperaVisibilidadeDe(WebElement element, int segundosAteTimeout)
	{
		return getWait().withTimeout( Duration.ofSeconds( segundosAteTimeout ) )
			.pollingEvery( Duration.ofMillis( Tempo._300.qtde() ) )
			.ignoring(StaleElementReferenceException.class)
	 ...
	 *         caducar*/
	default boolean esperaAteElementoSumir(By by)
	{
	 ...
	 * @return true se o elemento não for encontrado ou se a referência ao elemento
	 *         caducar*/
	default boolean esperaAteElementoSumir(By by, int segundosAteTimeout)
	{
	 ...
	 * @return true se o elemento não for encontrado ou se a referência ao elemento
	 *         caducar*/
	default boolean esperaAteElementoSumir(WebElement element)
	{
	 ...
	 * @return true se o elemento não for encontrado ou se a referência ao elemento
	 *         caducar*/
	default boolean esperaAteElementoSumir(WebElement element, int segundosAteTimeout)
	{
		boolean sumiu = false;
